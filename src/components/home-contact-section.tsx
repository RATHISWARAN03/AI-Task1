...
export default function HomeContactSection() {
  ...
  return (
    <section id="contact-form" className="pt-0 pb-12 sm:pb-16">
                ...
                <Form {...form}>
                  ...
                  >
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full bg-[linear-gradient(90deg,rgba(250,10,182,1)_0%,rgba(168,74,186,1)_84%,rgba(113,121,217,1)_100%)]
    text-white"
                    >
                      Send Message
                    </Button>
            ...
            {contactDetails.map((detail) => (
              <Card key={detail.title}>
                <CardContent className="flex items-start gap-6 p-6">
                  <div className="w-16 h-16 rounded-xl bg-pink-200 text-[#EC277A] flex items-center justify-center flex-shrink-0">
